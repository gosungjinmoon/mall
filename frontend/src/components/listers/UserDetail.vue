<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="HomeAddress" v-model="item.homeAddress" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="CardNumber" v-model="item.cardNumber" :editMode="editMode" @change="change" />
            </div>
            <div>
